            ...
            <div class="card p-3 mb-3 mt-5 shadow p-3 mb-5 bg-body-tertiary rounded"
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <h5>ID Penyewaan</h5>
                        <h4>BB00{{ $order->id }}</h4>
                        <img src="{{ url('Storage/' . $order->car->boat_img) }}" class="img-fluid rounded-start"
                            alt="...">
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">{{ $order->car->name }}</p>
                            <h5 class="card-title">Kategori</h5>
                            <p class="card-text">{{ $order->car->category }}</p>
                            <h5 class="card-title">Tanggal Sewa</h5>
                    ...
                    <div class="col-md-5 me-">
                        <div class="card-body text-end">
                            <div class="card-content mb-3">
                                ...
                                <h4 class="card-text fw-bold text-danger"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="20" height="20" fill="currentColor" class="bi bi-x-circle"
                                        viewBox="0 0 16 16">
                                        <path
                                ...
                                <h4 class="card-text fw-bold text-primary"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="20" height="20" fill="currentColor" class="bi bi-hourglass-bottom mb-1"
                                        viewBox="0 0 16 16">
                                        <path
                            ...
                            <button type="button" class="btn btn-success mt-4 w-100" data-bs-toggle="modal"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-start">
                                            <div class="mb-3">
                                                ...
                                                <form action="{{ route('submit_payment_receipt', $order->payment) }}"
                                                    method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <input class="form-control" placeholder="Input bukti" type="file"
                                                        id="formFileMultiple" multiple name="payment_receipt">
                                            </div>
                                        </div>
